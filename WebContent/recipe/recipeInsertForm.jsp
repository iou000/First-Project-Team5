		...
		<div id="contents">
			<div class="innercon">
				<section class="conarea">
					...
					<form id="frmMassOrdInqrInf" method="POST" action="app?command=recipe_insert" enctype="multipart/form-data" onsubmit="return checkInsertForm()">
					    <fieldset class="form-field">
					        ...
					        <dl>
					            ...
					            <dd>
					            	<label class="form-entry">
					            		<input type="text" name="title" title="레시피 제목 입력" maxlength="20" value="" placeholder="레시피 제목을 작성해주세요!">
					            	</label>
					            </dd>
					        </dl>
					        <dl>
					            ...
					            <dd>
					            	<label class="form-entry">
					            		<input type="text" name="intro" title="레시피 소개 입력" maxlength="40" value="" placeholder="레시피 소개를 작성해주세요!" >					                 
					            	</label>
					            </dd>
					        </dl>
					        <dl>
							...
							<dl>
					            ...
					            <dd>
					                <textarea placeholder="예: 물 1L, 마늘 한 쪽, 돼지고기 300g" name="ingredients" maxlength="500"></textarea>
					                <div class="infotxt">
					                    <ul>
					        ...
					        <dl>
					            ...
					            <dd>
					                <textarea placeholder="예: " name="details" maxlength="500"></textarea>
					                <div class="infotxt">
					                    <ul>
